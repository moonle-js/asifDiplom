export default function Equipment({itemName, itemDateAdded, itemQuality}){
    ...
    let bgColor = '';
    (100 - cislo/10000000) > 50 ? bgColor = 'green' : bgColor = "red";
    ...
    return(
        <div className="w-[80%] h-[100px] bg-[#00377E] rounded-[15px] flex items-center p-[20px]">
            ...
            <p style={{width: `${100 - (cislo/10000000)}px`, backgroundColor: bgColor, height: "20px", borderRadius: '25px', marginLeft: "auto"}}>
